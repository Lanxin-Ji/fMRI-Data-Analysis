...
for i=1:7
    for j = 1:10
        foldername = sprintf('/media/jilanxin/DATA2/DFC_project/MSC-derivatives/data_nifti_cond3/sub%02d/sess%02d/',i,j);
        cd(foldername);
...
%         filename = sprintf('/media/jilanxin/DATA2/DFC_project/MSC-derivatives/data_nifti_cond3/sub%02d/sess%02d/func_cond1.nii.gz',i,j);
%         disp(filename)
    end
end
